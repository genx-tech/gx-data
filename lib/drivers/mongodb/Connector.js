...
class MongodbConnector extends Connector {
  constructor(connectionString, options) {
    ...
    _defineProperty(this, "updatedCount", context => context.result.modifiedCount);

    _defineProperty(this, "deletedCount", context => context.result.deletedCount);

    _defineProperty(this, "findAll_", this.find_);
