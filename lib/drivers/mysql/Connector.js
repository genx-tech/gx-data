...
class MySQLConnector extends Connector {
  ...
  buildQuery(model, {
    ...
    needDistinctForLimit && (needDistinctForLimit = hasJoining);
    ...
    if (hasTotalCount || needDistinctForLimit) {
      const distinctField = this._escapeIdWithAlias(typeof $totalCount === 'string' ? $totalCount : $key, hasJoining, aliasMap);
